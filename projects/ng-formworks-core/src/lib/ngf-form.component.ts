...
export const JSON_SCHEMA_FORM_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NGFFormComponent),
  multi: true,
};

/**
 * @module 'NGFFormComponent' - Angular JSON Schema Form
 *
...
export class NGFFormComponent implements ControlValueAccessor, OnChanges, OnInit,OnDestroy {
  ...
  setFormValues(formValues: any, resetFirst = true) {
    if (formValues) {
      ...
      this.jsf.formGroup && this.jsf.formGroup.reset();
    }
  }
